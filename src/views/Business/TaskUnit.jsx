      ...
      <div>
        <div style={{ display: 'flex' }}>
          ...
          >
            ...
            >
              <label>完成数</label>
              <pre
                style={{ color: '#0078FF', fontSize: '24px', margin: '8px 0' }}
              >
                {outCity?.finishTotal}
                <span style={{ color: '#303133', fontSize: '12px' }}>项</span>
              </pre>
              <label>占比</label>
          ...
          >
            ...
            >
              <label>完成数</label>
              <pre
                style={{ color: '#FF7937', fontSize: '24px', margin: '8px 0' }}
              >
                {other?.finishTotal}
                <span style={{ color: '#303133', fontSize: '12px' }}>项</span>
              </pre>
          ...
          >
            ...
            >
              <label>完成数</label>
              <pre
                style={{ color: '#28D2B0', fontSize: '24px', margin: '8px 0' }}
              >
                {tai?.finishTotal}
                <span style={{ color: '#303133', fontSize: '12px' }}>项</span>
              </pre>
        ...
        >
          ...
          <TableColumn label="市外服务业">
            <TableColumn prop="outPlan" label="任务数" />
            <TableColumn prop="outFinish" label="完成数" />
          </TableColumn>
          <TableColumn label="其他产业">
            <TableColumn prop="otherPlan" label="任务数" />
            <TableColumn prop="otherFinish" label="完成数" />
          </TableColumn>
          <TableColumn label="台资合同">
            <TableColumn prop="taiPlan" label="任务数" />
            <TableColumn prop="taiFinish" label="完成数" />
          </TableColumn>
        </Table>
      </div>
    );
